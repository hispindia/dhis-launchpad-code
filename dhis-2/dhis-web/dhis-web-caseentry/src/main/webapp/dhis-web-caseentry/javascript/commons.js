...
function validateIdentifier( patientId, programId, paramsDiv, isTabSaved )
{
	...
	$.ajax({
		...
		success: function(json) {
            if( json.response == 'success' ) {
                saveIdentifierAndAttribute( patientId, programId, paramsDiv, isTabSaved );
            }
            else {
...
function saveIdentifierAndAttribute( patientId, programId, paramsDiv, isTabSaved )
{
	var params  = getParamsForDiv(paramsDiv);
    params += "&patientId=" + patientId;
    params +="&programId=" + programId;
	...
	$.ajax({
			...
			data: params,
			success: function(json) {
				if(isTabSaved!=undefined && isTabSaved)
				{
