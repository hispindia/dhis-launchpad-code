...
.service('DashboardLayoutService', function($http) {
    ...
    var w = {};
    w.enrollmentWidget = {title: 'registration', view: "components/enrollment/enrollment.html", show: true, expand: true, parent: 'biggerWidget', order: 0};
    ...
    w.profileWidget = {title: 'equipment_details', view: "components/profile/profile.html", show: true, expand: true, parent: 'smallerWidget', order: 1};
