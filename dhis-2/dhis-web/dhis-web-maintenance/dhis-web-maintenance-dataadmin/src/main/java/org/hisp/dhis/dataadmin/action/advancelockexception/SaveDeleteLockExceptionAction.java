                    ...
                    for ( DataSet  dataSet : dataSets )
                    {
                        for ( Period  period : periods )
                        {
                            ...
                            if ( organisationUnit.getDataSets().contains( dataSet ) )
                            {
                                ...
                                if( !dataSetService.getLockExceptionByOrgUnitPeriodDataSet( organisationUnit.getId(), period.getId(), dataSet.getId() ) )
                                {
                ...
                if ( organisationUnit != null )
                {
                    for ( DataSet  dataSet : dataSets )
                    {
                        for ( Period  period : periods )
                        {
                            if ( organisationUnit.getDataSets().contains( dataSet ) )
                            {   
                                dataSetService.deleteLockException( dataSet, period, organisationUnit );
                            }
                        }
                    }
                }
