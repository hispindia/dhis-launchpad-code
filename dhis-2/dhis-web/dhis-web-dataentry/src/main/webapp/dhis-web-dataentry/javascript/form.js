...
{
	/*var confirmedForVald = confirm( i18n_validation_before_confirm_complete );
...
function disableUndoButton()
{
    $( '#completeButton' ).removeAttr( 'disabled' );
    $( '#undoButton' ).attr( 'disabled', 'disabled' );
    $( '#completeDlgButton' ).removeAttr( 'disabled' );    
}
