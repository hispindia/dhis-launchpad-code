...
function printBlankForm()
{
	...
	//document.getElementById('htmlCode').value = document.getElementById('contentDiv').innerHTML;
	
	/*
	var temp = document.getElementById('contentDiv').innerHTML;
	alert( temp );
	
	var url = 'exportDataEntryScreenToExcel.action?htmlCode='+ document.getElementById('contentDiv').innerHTML;
