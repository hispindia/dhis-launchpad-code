Ext.onReady( function() {
	...
	createViewport = function() {
        ...
        onPeriodTypeSelect = function() {
            ...
            var periods = ptype.get(type).generatePeriods({
		...
		pluginItem = Ext.create('Ext.menu.Item', {
			...
			handler: function() {
				...
				text += '<html>\n<head>\n';
				text += '<link rel="stylesheet" href="http://dhis2-cdn.org/v216/ext/resources/css/ext-plugin-gray.css" />\n';
				text += '<script src="http://dhis2-cdn.org/v216/ext/ext-all.js"></script>\n';
				text += '<script src="http://dhis2-cdn.org/v216/plugin/table.js"></script>\n';
				text += '</head>\n\n<body>\n';
