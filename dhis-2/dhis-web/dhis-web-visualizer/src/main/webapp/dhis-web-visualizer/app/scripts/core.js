			...
			web.chart.createChart = function(ns) {
                ...
                getDefaultStore = function() {
                    ...
                    if (xLayout.showTrendLine) {
                        for (var i = 0, regression, key; i < failSafeColumnIds.length; i++) {
                            regression = new SimpleRegression();
                            key = conf.finals.data.trendLine + failSafeColumnIds[i];
                            ...
                            xResponse.metaData.names[key] = DV.i18n.trend + ' (' + xResponse.metaData.names[failSafeColumnIds[i]] + ')';
                        }
                    }
