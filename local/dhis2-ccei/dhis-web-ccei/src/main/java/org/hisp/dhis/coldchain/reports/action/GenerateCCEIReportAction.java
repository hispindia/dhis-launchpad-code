        ...
        throws Exception, JRException
    {
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.ELECTRICITY_AVAILABILITY ) )
        {
            ...
            if ( dataElemnet != null && dataElemnet.getOptionSet() != null )
            {
                ...
                List<Option> options = new ArrayList<Option>( dataElemnet.getOptionSet().getOptions() );
                for ( Option option : options )
                {
                    frb.addColumn( option.getName(), dataElemnet.getId() + "_" + option.getName(), String.class.getName(), 24, true );
                    frb.addColumn( "%", dataElemnet.getId() + "_" + option.getName() + "_%", String.class.getName(), 24, true );
                }
                ...
                for ( Integer orgUnitGroupId : orgunitGroupList )
                {
                    ...
                    if ( totalFacilities != 0 )
                    {
                        ...
                        if ( dataElemnet != null && dataElemnet.getOptionSet() != null )
                        {
                            ...
                            for ( Option option : options )
                            {
                                Integer optionValueCount = dataValueCountMap.get( option.getName() );
                                if ( optionValueCount == null )
                                {
                                    optionValueCount = 0;
                                }

                                numberOfData.put( dataElemnet.getId() + "_" + option.getName(), optionValueCount + "" );
                                ...
                                numberOfData.put( dataElemnet.getId() + "_" + option.getName() + "_%",
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.REFRIGERATOR_FREEZER_UTILIZATION_PIE ) )
        {
            ...
            if ( equipmentTypeAttribute.getOptionSet() != null )
            {
                ...
                List<Option> equipmentTypeAttributeOptions = new ArrayList<Option>( equipmentTypeAttribute.getOptionSet().getOptions() );
                for ( Option equipmentTypeAttributeOption : equipmentTypeAttributeOptions )
                {
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.REFRIGERATOR_FREEZER_UTILIZATION_BAR ) )
        {
            ...
            for ( String model : modelList )
            {
                ...
                if ( equipmentTypeAttribute.getOptionSet() != null )
                {
                    ...
                    List<Option> inventoryTypeAttributeOptions = new ArrayList<Option>( equipmentTypeAttribute.getOptionSet().getOptions() );
                    
                    for ( Option inventoryTypeAttributeOption : inventoryTypeAttributeOptions )
                    {
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.REFRIGERATOR_FREEZER_UTILIZATION ) )
        {
            ...
            if ( equipmentTypeAttribute.getOptionSet() != null )
            {
                ...
                for ( Option inventoryTypeAttributeOption : inventoryTypeAttributeOptions )
                {
                    frb.addColumn( "#", inventoryTypeAttributeOption.getName() + "_#", String.class.getName(), 50, true );
                    frb.addColumn( "%", inventoryTypeAttributeOption.getName() + "_%", String.class.getName(), 50, true );
                }
            ...
            for ( String model : modelList )
            {
                ...
                if ( equipmentTypeAttribute.getOptionSet() != null )
                {
                    ...
                    for ( Option inventoryTypeAttributeOption : inventoryTypeAttributeOptions )
                    {
                        ...
                        numberOfData.put( inventoryTypeAttributeOption.getName() + "_#", equipmentUtilisationCount + "" );
                        numberOfData.put( inventoryTypeAttributeOption.getName() + "_%", percentageEquipmentUtilisation + "" );
                    }
                }
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.EQUIPMENT_BY_AVAILABILITY_OF_ELECTRICITY ) )
        {
            ...
            if ( dataElemnet.getOptionSet() != null )
            {
                ...
                for ( Option option : options )
                {
                    frb.addColumn( option.getName(), dataElemnet.getId() + "_" + option.getName(), String.class.getName(), 50, true );
                }
            ...
            for ( String equipment : equiplmentTypeList )
            {
                ...
                {
                    Integer count = 0;
                    if ( electricityAvailabilityMap.get( option.getName() ) != null )
                    {
                        count = electricityAvailabilityMap.get( option.getName() );
                    }
                    numberOfData.put( dataElemnet.getId() + "_" + option.getName(), count + "" );
                }
                tableData.add( numberOfData );
            }
        ...
        else if ( ccemReport.getReportType().equals( CCEMReport.ALL_ENERGY_AVAILABILITY_AT_FACILITIES ) )
        {
            ...
            */
            ...
            List<Option> dataElement1Options = new ArrayList<Option>();
            List<Option> dataElement2Options = new ArrayList<Option>();
            List<Option> dataElement3Options = new ArrayList<Option>();

            if ( dataElement1.getOptionSet() != null )
            {
                //dataElement1Options = new ArrayList<String>( dataElement1.getOptionSet().getOptions() );
                dataElement1Options = new ArrayList<Option>( dataElement1.getOptionSet().getOptions() );
                for ( Option option : dataElement1Options )
                {
                    frb.addColumn( option.getName(), dataElement1.getId() + "_" + option.getName(), String.class.getName(), 24, true );
                    frb.addColumn( "%", dataElement1.getId() + "_" + option.getName() + "_%", String.class.getName(), 24, true );
                }
            }
            ...
            if ( dataElement2.getOptionSet() != null )
            {
                ...
                dataElement2Options = new ArrayList<Option>( dataElement2.getOptionSet().getOptions() );
                for ( Option option : dataElement2Options )
                {
                    frb.addColumn( option.getName(), dataElement2.getId() + "_" + option.getName(), String.class.getName(), 24, true );
                    frb.addColumn( "%", dataElement2.getId() + "_" + option.getName() + "_%", String.class.getName(), 24, true );
                }
            }
            ...
            if ( dataElement3.getOptionSet() != null )
            {
                ...
                dataElement3Options = new ArrayList<Option>( dataElement3.getOptionSet().getOptions() );
                for ( Option option : dataElement3Options )
                {
                    frb.addColumn( option.getName(), dataElement3.getId() + "_" + option.getName(), String.class.getName(), 24, true );
                    frb.addColumn( "%", dataElement3.getId() + "_" + option.getName() + "_%", String.class.getName(), 24, true );
                }
            }
                ...
                for ( Integer orgUnitGroupId : orgunitGroupList )
                {
                    ...
                    if ( totalFacilities != 0 )
                    {
                        ...
                        if ( dataElement1.getOptionSet() != null )
                        {
                            ...
                            List<Option> options = new ArrayList<Option>( dataElement1.getOptionSet().getOptions() );
                            for ( Option option : options )
                            {
                                Integer optionValueCount = dataValueCountMap.get( option.getName() );
                                if ( optionValueCount == null )
                                ...
                                numberOfData.put( dataElement1.getId() + "_" + option.getName(), optionValueCount + "" );
                                double percentageOfOptionValueCount = 0.0;
                                try
                                {
                                    percentageOfOptionValueCount = (double) optionValueCount / (double) totalFacilities
                                ...
                                numberOfData.put( dataElement1.getId() + "_" + option.getName() + "_%",
                                    percentageOfOptionValueCount + "" );
                            }
                        }
                        ...
                        if ( dataElement2.getOptionSet() != null )
                        {
                            ...
                            List<Option> options = new ArrayList<Option>( dataElement2.getOptionSet().getOptions() );
                            for ( Option option : options )
                            {
                                Integer optionValueCount = dataValueCountMap.get( option.getName() );
                                if ( optionValueCount == null )
                                ...
                                numberOfData.put( dataElement2.getId() + "_" + option.getName(), optionValueCount + "" );
                                double percentageOfOptionValueCount = 0.0;
                                try
                                {
                                    percentageOfOptionValueCount = (double) optionValueCount / (double) totalFacilities
                                ...
                                numberOfData.put( dataElement2.getId() + "_" + option.getName() + "_%",
                                    percentageOfOptionValueCount + "" );
                            }
                        }
                        ...
                        if ( dataElement3.getOptionSet() != null )
                        {
                            ...
                            List<Option> options = new ArrayList<Option>( dataElement3.getOptionSet().getOptions() );
                            for ( Option option : options )
                            {
                                Integer optionValueCount = dataValueCountMap.get( option.getName() );
                                if ( optionValueCount == null )
                                ...
                                numberOfData.put( dataElement3.getId() + "_" + option.getName(), optionValueCount + "" );
                                double percentageOfOptionValueCount = 0.0;
                                try
                                {
                                    percentageOfOptionValueCount = (double) optionValueCount / (double) totalFacilities
                                ...
                                numberOfData.put( dataElement3.getId() + "_" + option.getName() + "_%",
                                    percentageOfOptionValueCount + "" );
                            }
                        }
