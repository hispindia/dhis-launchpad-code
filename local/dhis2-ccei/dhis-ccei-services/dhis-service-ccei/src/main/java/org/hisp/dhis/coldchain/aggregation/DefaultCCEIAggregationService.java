    ...
    implements CCEIAggregationService
{
    ...
    public void calculateRefrigeratorCountByStatusAndFacilty( Period period, Set<OrganisationUnit> orgUnits)
    {
        ...
        {
            if( option.getName().equalsIgnoreCase( Lookup.CCEI_REF_EQUIPMENT_FUCTIONING ) )
            {
                try
                {
            ...
            else if( option.getName().equalsIgnoreCase( Lookup.CCEI_REF_EQUIPMENT_AWAITING_REPAIR ) )
            {
                try
                {
                    query =  " SELECT equipment.organisationunitid,COUNT(*) FROM equipment " +
            ...
            else if( option.getName().equalsIgnoreCase( Lookup.CCEI_REF_EQUIPMENT_UNSERVICABLE ) )
            {    
                try
                {
                    query =  " SELECT equipment.organisationunitid,COUNT(*) FROM equipment " +
