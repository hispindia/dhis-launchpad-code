...
public class HibernateModelTypeAttributeGroupStore extends HibernateIdentifiableObjectStore<ModelTypeAttributeGroup> implements ModelTypeAttributeGroupStore
{
   ...
   */
    ...
    @Override
    public ModelTypeAttributeGroup getModelTypeAttributeGroupByUid( String uid )
    {
        return ( ModelTypeAttributeGroup ) getCriteria( Restrictions.eq( "uid", uid ) ).uniqueResult();
    }
