...
//----------------------------------------------------------------------
//Get Periods For OrgUnit Wise Progress Report
//----------------------------------------------------------------------

function getPeriodsForOrgUnitWiseProgressReport()
{
	var periodTypeList = document.getElementById('periodTypeId');
	var periodTypeId = periodTypeList.options[periodTypeList.selectedIndex].value;
	var availablePeriods = document.getElementById('availablePeriods');
	...
	if ( periodTypeId != "NA" ) 
	{
		$.post("getPeriods.action",
			...
			function (data)
			{
				getPeriodsForOrgUnitWiseProgressReportReceived(data);
			},'xml');
	} 
	else 
	{
...
function getPeriodsForOrgUnitWiseProgressReportReceived(xmlObject)
{
	var availablePeriods = document.getElementById("availablePeriods");
	var availablePeriodsto = document.getElementById("availablePeriodsto");
