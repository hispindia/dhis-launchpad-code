    ...
    implements Action
{
        ...
        throws Exception
    {
        ...
        PeriodType periodType = periodService.getPeriodTypeByName( report.getPeriodType().getName() );
        
        report.setPeriodType( periodService.getPeriodTypeByClass( periodType.getClass() ) );
        
        //System.out.println( "Report Id " + report.getId() + "---Period Type -- " + report.getPeriodType().getName()  );
        
        //System.out.println( report.getId() + "---" + report.getPeriodType().getId() );
