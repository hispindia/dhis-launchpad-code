...
public class SendSMSJob
{
    ...
    private RawSMSService rawSMSService;
    
    public void setRawSMSService( RawSMSService rawSMSService )
    {
        this.rawSMSService = rawSMSService;
    }
    ...
    /*
     * This method will get raw sms from RAWSMS table and Create XML Files
     * also import data from xml files that are in pending folder into
     * DHIS and then send acknowledgement for max of 30 sms at a time.
     */
    public void executegetRawSMS_CreateXML_ImportAndSendSMSProcess()
    {
        System.out.println("RawSMS_CreateXML_ImportAndSendSMSProcess Job Started at : "+new Date() );
        ...
        smsService.getRawSMS_CreateXML();
        
        mobileImportService.importPendingFiles();

        //smsService.sendDrafts();
        
        System.out.println("RawSMS_CreateXML_ImportAndSendSMSProcess Job Ended at : "+new Date() );
    }
