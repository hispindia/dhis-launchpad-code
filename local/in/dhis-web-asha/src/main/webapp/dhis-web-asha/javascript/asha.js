...
function showAddASHABeneficiaryForm( ashaId, selectedPeriodId )
{
	...
	jQuery('#addUpdateASHAProfileDiv').load('showAddASHABeneficiaryForm.action',
		{
			id:ashaId,
			tempSelectedPeriodId:selectedPeriodId
		}, 
		function()
		{
			showById('addUpdateASHAProfileDiv');
...
// Load ASHA MO Approve Form

function showASHAMOApproveForm( ashaId )
{
	...
	jQuery('#addUpdateASHAProfileDiv').load('loadASHAMOApproveDataEntryForm.action',
		{
			id:ashaId,
		}, 
		function()
...
function showASHAMOApproveForm( ashaId )
{
	...
	jQuery('#addUpdateASHAProfileDiv').load('showASHAMOApproveForm.action',
		{
			id:ashaId,
		}, 
		function()
...
function showASHAAAApproveForm( ashaId )
{
	...
	jQuery('#addUpdateASHAProfileDiv').load('loadASHAAAApproveDataEntryForm.action',
		{
			id:ashaId,
		}, 
		function()
...
function showASHAAAApproveForm( ashaId )
{
	...
	jQuery('#addUpdateASHAProfileDiv').load('showASHAAAApproveForm.action',
		{
			id:ashaId,
		}, 
		function()
