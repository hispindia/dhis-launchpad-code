...
function checkBoxValueChange92()
{
	if( document.getElementById("checkboxdeps92").checked )
	{
		document.getElementById( "deps92" ).value = 1;
		
	}
	/*
	if( document.getElementById("checkboxdeps92").checked == true )
	{
		 document.getElementById( "deps92" ).value = 1;
	...
	*/
	...
	{
		document.getElementById( "deps92" ).value = 0;
	    
	}
	
	//alert( document.getElementById( "deps92" ).value );
...
function checkBoxValueChange93()
{
	if( document.getElementById("checkboxdeps93").checked )
	{
		 document.getElementById( "deps93" ).value = 1;
		
	}
	/*
	if( document.getElementById("checkboxdeps93").checked == true )
	{
		 document.getElementById( "deps93" ).value = 1;
	...
	*/
	...
	{
		document.getElementById( "deps93" ).value = 0;
...
function checkBoxValueChange94()
{
	if( document.getElementById("checkboxdeps94").checked )
	{
		 document.getElementById( "deps94" ).value = 1;
		
	}
	
	/*
	if( document.getElementById("checkboxdeps94").checked == true )
	{
		 document.getElementById( "deps94" ).value = 1;
	...
	*/
	...
	{
		document.getElementById( "deps94" ).value = 0;
...
function checkBoxValueChange96()
{
	if( document.getElementById("checkboxdeps96").checked )
	{
		 document.getElementById( "deps96" ).value = 1;
		
	} 
	
	/*
	if( document.getElementById("checkboxdeps96").checked == true )
	{
		 document.getElementById( "deps96" ).value = 1;
	...
	*/
	...
	{
		document.getElementById( "deps96" ).value = 0;
...
function checkBoxValueChange396()
{
	if( document.getElementById("checkboxdeps396").checked == true )
	{
		 document.getElementById( "deps396" ).value = 1;
		
	}    
	else
	{
		document.getElementById( "deps396" ).value = 0;
...
function calCulateAmount396()
{
	var amountDE395 = $( '#de395' ).val();
	var amountDEPS396 = $( '#deps396' ).val();
	
	var totalAmount396 = amountDE395 * amountDEPS396;
	
	document.getElementById( "depsamount396" ).value = totalAmount396;
...
function calculateAwardAmount()
{
	var awardAmountDEPS124 = $( '#deps124' ).val();
	
	var totalAwardAmount124 = awardAmountDEPS124;
	
	document.getElementById( "depsamount124" ).value = totalAwardAmount124;
...
*/
	...
	if( isInt( document.getElementById( "depsamount396" ).value ) )
	{
		var temp = document.getElementById( "depsamount396" ).value;
		tempTotal = parseInt( temp );
		group1Total = group1Total + tempTotal;
	}	
...
function calCulateAmount400()
{
	var amountDE397 = $( '#de397' ).val();
	var amountDEPS400 = $( '#deps400' ).val();
	
	var totalAmount400 = amountDE397 * amountDEPS400;
	
	document.getElementById( "depsamount400" ).value = totalAmount400;
...
function calCulateAmount399()
{
	var amountDE398 = $( '#de398' ).val();
	var amountDEPS399 = $( '#deps399' ).val();
	
	var totalAmount399 = amountDE398 * amountDEPS399;
	
	document.getElementById( "depsamount399" ).value = totalAmount399;
...
function calculateJSYGroupTotal()
{
	...
	if( isInt( document.getElementById( "depsamount400" ).value ) )
	{
		var temp = document.getElementById( "depsamount400" ).value;
		tempTotal = parseInt( temp );
		group1Total = group1Total + tempTotal;
	}
	...
	if( isInt( document.getElementById( "depsamount399" ).value ) )
	{
		var temp = document.getElementById( "depsamount399" ).value;
		tempTotal = parseInt( temp );
		group1Total = group1Total + tempTotal;
	}
...
function checkBoxValueChange88()
{
	if( document.getElementById("checkboxdeps88").checked == true )
	{
		 document.getElementById( "deps88" ).value = 1;
		
	}    
	else
	{
		document.getElementById( "deps88" ).value = 0;
...
function checkBoxValueChange98()
{
	if( document.getElementById("checkboxdeps98").checked == true )
	{
		 document.getElementById( "deps98" ).value = 1;
		
	}    
	else
	{
		document.getElementById( "deps98" ).value = 0;
...
function checkBoxValueChange97()
{
	if( document.getElementById("checkboxdeps97").checked == true )
	{
		 document.getElementById( "deps97" ).value = 1;
		
	}    
	else
	{
		document.getElementById( "deps97" ).value = 0;
...
function checkBoxValueChange122()
{
	if( document.getElementById("checkboxdeps122").checked == true )
	{
		 document.getElementById( "deps122" ).value = 1;
		
	}    
	else
	{
		document.getElementById( "deps122" ).value = 0;
...
function checkBoxValueChange120()
{
	if( document.getElementById("checkboxdeps120").checked == true )
	{
		 document.getElementById( "deps120" ).value = 1;
		
	}    
	else
	{
		document.getElementById( "deps120" ).value = 0;
