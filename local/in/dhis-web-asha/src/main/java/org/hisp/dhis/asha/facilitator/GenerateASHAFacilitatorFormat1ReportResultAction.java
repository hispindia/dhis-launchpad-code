 ...
 */
public class GenerateASHAFacilitatorFormat1ReportResultAction implements Action
{
    ...
    */
    ...
    public String execute() throws Exception
    {
        ...
        period = periodService.getPeriod( startPeriod );
        ...
        sheet0.addCell( new Label( colStart+2, rowStart, "Name of Facilitator : " + facilitator.getName() , getCellFormat1() ) );
        ...
        */
        ...
        //facilitators = new ArrayList<Facilitator> ( facilitatorService.getFacilitatorByOrganisationUnit( selectedOrgUnit ) );
        
        /*
        facilitators = new ArrayList<Facilitator> ( facilitatorService.getFacilitatorByOrganisationUnit( selectedOrgUnit ) );
        String facilitatorIdsByComma = getCommaDelimitedString( getIdentifiers( Facilitator.class, facilitators ) );
        
        
        List<Period> periodList = new ArrayList<Period>();
        periodList.add( period );
        
        String periodIdsByComma = getCommaDelimitedString( getIdentifiers( Period.class, periodList ) );
        
        Collections.sort( facilitators, new IdentifiableObjectNameComparator() );
        
        Collections.sort( dataElements, new IdentifiableObjectNameComparator() );
        
        Map<String, Integer> yesCountMap = new HashMap<String, Integer>( ashaService.getYesCountSumForFacilitator( facilitatorIdsByComma, periodIdsByComma, dataSet.getId() ) );
