...
public class ShowAddASHABeneficiaryFormAction implements Action
{
    ...
    private String tempSelectedPeriodId;
    
    public void setTempSelectedPeriodId( String tempSelectedPeriodId )
    {
        this.tempSelectedPeriodId = tempSelectedPeriodId;
    }

    private String selectedPeriodIdAfterAdd;
    
    public String getSelectedPeriodIdAfterAdd()
    {
        return selectedPeriodIdAfterAdd;
    }
    ...
    public String execute()
    {
        ...
        if( tempSelectedPeriodId !=null )
        {
            selectedPeriodIdAfterAdd = tempSelectedPeriodId;
        }
        
        //System.out.println(   " tempSelectedPeriodId : " + tempSelectedPeriodId + " selectedPeriodId After Add " + selectedPeriodIdAfterAdd );
