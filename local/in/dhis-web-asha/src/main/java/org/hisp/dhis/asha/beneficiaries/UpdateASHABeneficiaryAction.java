    ...
    implements Action
{
    ...
    private String dataElementId1;
    
    public void setDataElementId1( String dataElementId1 )
    {
    ...
    */
    ...
    public String execute()
    {
        ...
        beneficiary.setMOApprove( 0 );
        beneficiary.setAAApprove( 0 );
        ...
        DataElement dataElement = dataElementService.getDataElement( Integer.parseInt( dataElementId1.split( ":" )[1] ) );
        
        //DataElement dataElement = dataElementService.getDataElement(  Integer.parseInt( dataElementId1) );
