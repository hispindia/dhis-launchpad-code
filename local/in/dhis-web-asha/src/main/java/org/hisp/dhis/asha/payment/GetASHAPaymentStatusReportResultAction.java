...
public class GetASHAPaymentStatusReportResultAction implements Action
{
    ...
    public String execute() throws Exception
    {
        ...
        //program = programService.getProgramByName( ASHA_ACTIVITY_DETAILS_PROGRAM_ID );
        ...
        for( OrganisationUnit orgUnit : orgUnitList )
        {
            ...
            String patientIdsByComma = getCommaDelimitedString( patientIds );
             ...
             Map<String, String> patientDataValueMap = new HashMap<String, String>( ashaService.getPatientDataValues( patientIdsByComma, dataElementIdsByComma, period.getStartDateString(), 4, 4 ));
