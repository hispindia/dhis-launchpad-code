...
public class LoadASHAAmountDetailsFormAction
    implements Action
{
    ...
    public String execute() throws Exception
    {
        ...
        // System.out.println("ashaid="+ashaId + " selPeriod=" +
        // selectedPeriodId + "PService=" + patientService);
        ...
        if ( programStageDataElements != null && programStageDataElements.size() > 0 )
        {
            for ( ProgramStageDataElement programStageDataElement : programStageDataElements )
            {
                ...
                // programStageDataElement.getDataElement().getName() +
                // "-- Count " + count );
            }
        }
        ...
        /*
        for( Integer deId : activityDetailsDataValueMap.keySet() ) 
        {      
            System.out.println( " De ID  : " + deId + "-- Value  " + activityDetailsDataValueMap.get( deId ) ); 
        }
        */
        ...
        /*
         ...
         {      
             int count = beneficiaryService.getCountByServicePeriodAndASHA( patient, period, de ); patientDataValueMap.put( de.getId() , ""+count);
