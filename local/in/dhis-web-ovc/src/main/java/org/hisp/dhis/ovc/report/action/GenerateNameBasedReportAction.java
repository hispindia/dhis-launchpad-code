    ...
    public String execute() throws Exception
    {
        ...
        */
        ...
        else
        {
            ...
            for( OrganisationUnit orgUnit : orgUnitList )
            {
                patients.addAll( patientService.searchPatients( searchTexts, orgUnit, null, null ) );
            }
        }
        ...
        {       
            ...
            else
            {
                ...
                for( OrganisationUnit orgUnit : orgUnitList )
                {
                    patients.addAll( patientService.searchPatients( savedSearchTexts, orgUnit, null, null ) );
                }
