...
*/
    ...
    public String execute() throws Exception 
    {
        ...
        if ( reportId.equalsIgnoreCase( "BLOCK_GRADING_REPORT" ) )
        {
            xmlFilePath = System.getenv( "DHIS2_HOME" ) + File.separator + raFolderName + File.separator + "xml" + File.separator + "ASHA_Outcome_Monitoring_Block.xml";
            inputTemplatePath = System.getenv( "DHIS2_HOME" ) + File.separator + raFolderName + File.separator + "xls" + File.separator + "ASHA_Outcome_Monitoring_Block.xls";
        }
        
        else if( reportId.equalsIgnoreCase( "DISTRICT_GRADING_REPORT" ) )
        {
            xmlFilePath = System.getenv( "DHIS2_HOME" ) + File.separator + raFolderName + File.separator + "xml" + File.separator + "ASHA_Outcome_Monitoring_District.xml";
            inputTemplatePath = System.getenv( "DHIS2_HOME" ) + File.separator + raFolderName + File.separator + "xls" + File.separator + "ASHA_Outcome_Monitoring_District.xls";
        }
        ...
        try
        {
            ...
            for( OrganisationUnit orgUnit : orgUnitList )
            {
                ...
                if ( reportId.equalsIgnoreCase( "BLOCK_GRADING_REPORT" ) )
                {
                    orgUnitBranch = orgUnit.getParent().getName();
                }
                
                else if( reportId.equalsIgnoreCase( "DISTRICT_GRADING_REPORT" ) )
                {
                    orgUnitBranch = orgUnit.getParent().getParent().getName();
                }
                //String orgUnitBranch = orgUnit.getParent().getParent().getName();
