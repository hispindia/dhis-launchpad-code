...
public class LoadASHATrainingDetailsFormAction implements Action
{
    ...
    public static final String ASHA_TRAINING_PROGRAM_STAGE = "ASHA Training Program Stage";//3.0
    ...
    */
    ...
    public String execute() throws Exception
    {
        ...
        for( ProgramStageDataElement programStageDataElement : programStageDataElements )
        {
            System.out.println( " DataElement Id  -- "  + programStageDataElement.getDataElement().getId() + " -- Name is -- " + programStageDataElement.getDataElement().getName()   );
        }
        */
