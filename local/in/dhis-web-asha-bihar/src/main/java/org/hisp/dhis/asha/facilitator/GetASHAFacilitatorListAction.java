...
{
    public static final String BLOCK_GROUP = "Block Group";//29.0
    ...
    public String execute()
    {
        ...
        Constant blockGroupConstant = constantService.getConstantByName( BLOCK_GROUP );
        
        OrganisationUnitGroup organisationUnitGroup = organisationUnitGroupService.getOrganisationUnitGroup( (int) blockGroupConstant.getValue() );
        
        if ( ( organisationUnit == null ) || ( !organisationUnitGroup.getMembers().contains( organisationUnit ) ) )
        {
            status = i18n.getString( "please_select_block" );
