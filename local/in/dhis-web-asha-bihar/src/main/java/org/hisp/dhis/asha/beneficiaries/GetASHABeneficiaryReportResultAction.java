    ...
    */
    ...
    public String execute() throws Exception
    {
        ...
        */
        ...
        sheet0.addCell( new Label( colStart + 6, rowStart, "Service Given", getCellFormat1() ) );
        sheet0.addCell( new Label( colStart + 7, rowStart, "Price", getCellFormat1() ) );
        ...
        for ( Beneficiary beneficiary : beneficiaryList )
        {
            ...
            sheet0.addCell( new Number( colStart + 7, rowStart, Double.parseDouble( beneficiary.getPrice()), getCellFormat2() ) );
