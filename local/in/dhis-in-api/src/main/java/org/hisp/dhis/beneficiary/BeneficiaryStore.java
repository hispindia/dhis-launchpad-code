...
public interface BeneficiaryStore
{
    ...
    Collection<Beneficiary> getAllBeneficiaryStatusByMO( Patient patient, Period period, Integer status );
    
    Collection<Beneficiary> getAllBeneficiaryStatusByAA( Patient patient, Period period, Integer status );
    
    Collection<Beneficiary> getAllBeneficiaryStatusPendingByMO( Patient patient, Integer status );
    
    Collection<Beneficiary> getAllBeneficiaryStatusPendingByAA( Patient patient, Integer status );
