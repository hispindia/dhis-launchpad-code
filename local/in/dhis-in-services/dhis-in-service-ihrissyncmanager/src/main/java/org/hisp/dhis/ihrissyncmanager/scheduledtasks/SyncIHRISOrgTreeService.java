...
public class SyncIHRISOrgTreeService implements Runnable{
    ...
    public void replicateIhrisOrgTree() {
        ...
        while (countryRowSet.next()) {
            ...
            List<OrganisationUnit> countryList = new ArrayList<OrganisationUnit >( organisationUnitService.getOrganisationUnitByName(countryName));

            OrganisationUnit country = countryList.get( 0 );

            OrganisationUnit countryParent = (OrganisationUnit) organisationUnitService.getOrganisationUnitByName(countryName);
            ...
            while (regionRowSet.next()) {
                ...
                List<OrganisationUnit> regionList = new ArrayList<OrganisationUnit>( organisationUnitService.getOrganisationUnitByName(regionName) );
                OrganisationUnit region = regionList.get( 0 );


                OrganisationUnit regionParent = (OrganisationUnit) organisationUnitService.getOrganisationUnitByName(countryName);
                ...
                while (districtRowSet.next()) {
                    ...
                    List<OrganisationUnit> districtList = new ArrayList<OrganisationUnit>( organisationUnitService.getOrganisationUnitByName(districtName) );
                    OrganisationUnit district = regionList.get( 0 );


                    OrganisationUnit districtParent = (OrganisationUnit) organisationUnitService.getOrganisationUnitByName(regionName);
                    ...
                    while (countyRowSet.next()) {
                        ...
                        List<OrganisationUnit> countrytList = new ArrayList<OrganisationUnit>( organisationUnitService.getOrganisationUnitByName(countyName));
                        OrganisationUnit county = regionList.get( 0 );


                        OrganisationUnit countyParent = (OrganisationUnit) organisationUnitService.getOrganisationUnitByName(districtName);
