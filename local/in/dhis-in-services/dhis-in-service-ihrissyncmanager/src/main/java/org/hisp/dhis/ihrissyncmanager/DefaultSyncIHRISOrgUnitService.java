...
public class DefaultSyncIHRISOrgUnitService implements SyncIHRISOrgUnitService {
    ...
    public OrganisationUnit createNewOrgUnit(String orgUnitName, String parentOrgUnitName)
    {
        ...
        List<OrganisationUnit> checkIfOrgUnitExistsList = new ArrayList<OrganisationUnit >( organisationUnitService.getOrganisationUnitByName(orgUnitName));

        OrganisationUnit checkIfOrgUnitExists = checkIfOrgUnitExistsList.get( 0 );

        OrganisationUnit checkIfParentOrgUnitExists = (OrganisationUnit) organisationUnitService.getOrganisationUnitByName(parentOrgUnitName);
