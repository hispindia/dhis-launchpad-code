    ...
    implements Action
{
    ...
    public String execute()
    {
        ...
        else
        {
            ...
            orgUnits = new ArrayList<OrganisationUnit>( organisationUnitService.getLeafOrganisationUnits( rootOrgUnit
                .getId() ) );
        ...
        {
            for ( OrganisationUnit o : organisationUnitService.getLeafOrganisationUnits( org.getId() ) )
            {
