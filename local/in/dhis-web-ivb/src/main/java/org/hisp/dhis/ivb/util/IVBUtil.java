...
public class IVBUtil
{
        ...
        throws Exception
    {
        ...
        Collection<Integer> userOrgUnitIds = new ArrayList<Integer>( getIdentifiers( OrganisationUnit.class, userOrgUnits ) );
        ...
        Collection<Integer> userDataElementIds = new ArrayList<Integer>( getIdentifiers( DataElement.class, userDataElements ) );
        ...
        for ( Object obj : csvRows )
        {
            ...
            */
            ...
            {            
                ...
                if( deValueType.equalsIgnoreCase( DataElement.VALUE_TYPE_INT ) )
                {
                    try
                    {
    ...
    public ExpressionValue findSubExpressionValue( String exp, OrganisationUnit orgUnit )
    {
        ...
        if( exp.contains( "#DATEVALUE#" ) )
        {
            ...
            if( dv != null )
            {
                ...
                else if( dataElement.getType().equalsIgnoreCase( DataElement.VALUE_TYPE_DATE ) &&  dv.getValue().trim().equalsIgnoreCase( "NA" ) )
                {                    
                }
                else
                {
