        ...
        for ( int i = 0; i < patternexpression.length; i++ )
        {
            ...
            for( DataElement de : dataElements )
            {
                ...
                if( dataValue != null && dataValue.getValue() != null && dataValue.getValue().trim() != "" )
                {
                    ...
                    if( de.getType().equalsIgnoreCase( DataElement.VALUE_TYPE_DATE ) &&  dataValue.getValue().trim().equalsIgnoreCase( "NA" ) )
                    {
                        isData = false; break;
                    }
                    else
        ...
        try
        {
            if ( expression.contains( "YEAROF" ) )
            {
                ...
                for ( DataElement de : deNuList )
                {
                    ...
                    if ( dv != null )
                    {
                        ...
                        else if( de.getType().equalsIgnoreCase( DataElement.VALUE_TYPE_DATE ) &&  dv.getValue().trim().equalsIgnoreCase( "NA" ) )
                        {
            ...
            else
            {
                ...
                for ( DataElement de : deNuList )
                {
                    ...
                    { 
                        if( de.getType().equalsIgnoreCase( DataElement.VALUE_TYPE_DATE ) &&  dv.getValue().trim().equalsIgnoreCase( "NA" ) )
                        {
                            DataElementValue = "";
                        }
                        else
