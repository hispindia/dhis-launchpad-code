...
public class ScheduleAdverseEventReportController17 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController17.class);
