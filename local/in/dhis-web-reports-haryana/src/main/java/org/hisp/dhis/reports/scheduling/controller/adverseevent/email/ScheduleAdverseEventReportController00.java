...
public class ScheduleAdverseEventReportController00 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController00.class);
	...
	private static final String SCHEDULING_POLICY_ID="1";
        ...
        throws Exception
    {
        ...
        Collection<Integer> dataElementIds = dataElementService.getDataElementIdsByGroupId(dataElementService.getDataElementGroup(reportService.getDataElementIds(reportDesignList).get(0).intValue()).getId());
