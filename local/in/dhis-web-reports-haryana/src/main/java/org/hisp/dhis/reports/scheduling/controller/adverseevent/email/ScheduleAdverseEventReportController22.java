...
public class ScheduleAdverseEventReportController22 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController22.class);
