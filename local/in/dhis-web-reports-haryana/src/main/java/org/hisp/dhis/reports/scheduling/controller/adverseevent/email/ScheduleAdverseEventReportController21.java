...
public class ScheduleAdverseEventReportController21 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController21.class);
