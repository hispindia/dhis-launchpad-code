...
public class ScheduleAdverseEventReportController05 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController05.class);
