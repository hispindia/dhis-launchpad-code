...
public class ScheduleAdverseEventReportController20 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController20.class);
