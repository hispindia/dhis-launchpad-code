...
public class ScheduleAdverseEventReportController23 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController23.class);
