...
public class ScheduleAdverseEventReportController02 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController02.class);
