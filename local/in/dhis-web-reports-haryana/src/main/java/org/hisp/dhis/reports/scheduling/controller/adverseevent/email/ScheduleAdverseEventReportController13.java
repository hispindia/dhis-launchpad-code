...
public class ScheduleAdverseEventReportController13 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController13.class);
