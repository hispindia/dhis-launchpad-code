...
public class ScheduleAdverseEventReportController16 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController16.class);
