...
public class ScheduleAdverseEventReportController09 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController09.class);
