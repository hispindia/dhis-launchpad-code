...
public class ScheduleAdverseEventReportController25 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController25.class);
