...
public class ScheduleAdverseEventReportController19 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController19.class);
