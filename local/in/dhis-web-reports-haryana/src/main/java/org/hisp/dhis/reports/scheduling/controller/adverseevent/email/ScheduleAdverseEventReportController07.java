...
public class ScheduleAdverseEventReportController07 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController07.class);
