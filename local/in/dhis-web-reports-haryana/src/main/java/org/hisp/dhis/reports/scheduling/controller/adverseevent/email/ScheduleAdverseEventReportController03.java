...
public class ScheduleAdverseEventReportController03 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController03.class);
