...
public class ScheduleAdverseEventReportController27 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController27.class);
