...
public class ScheduleAdverseEventReportController14 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController14.class);
