...
public class ScheduleAdverseEventReportController06 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController06.class);
