...
public class ScheduleAdverseEventReportController18 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController18.class);
