...
public class ScheduleAdverseEventReportController10 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController10.class);
