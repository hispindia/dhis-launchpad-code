...
public class ScheduleAdverseEventReportController08 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController08.class);
