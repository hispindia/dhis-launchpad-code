...
public class ScheduleAdverseEventReportController11 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController11.class);
