...
public class ScheduleAdverseEventReportController24 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController24.class);
