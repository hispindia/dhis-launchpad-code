...
public class ScheduleAdverseEventReportController28 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController28.class);
