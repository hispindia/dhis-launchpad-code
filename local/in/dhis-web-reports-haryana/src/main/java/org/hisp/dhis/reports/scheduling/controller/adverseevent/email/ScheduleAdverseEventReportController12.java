...
public class ScheduleAdverseEventReportController12 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController12.class);
