...
public class ScheduleAdverseEventReportController15 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController15.class);
