...
public class ScheduleAdverseEventReportController04 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController04.class);
