    ...
    */
        ...
        throws Exception
    {
        ...
        */
        ...
        Report_in report = new Report_in( name, reportmodel, periodType, excelname, xmlname, reporttype, schedulable, emailable );
        ...
        {
          report.setSchedulingPolicyId( schedulingPolicyId );
        }
        
        report.setSchedulable( schedulable );
        report.setEmailable( emailable );
