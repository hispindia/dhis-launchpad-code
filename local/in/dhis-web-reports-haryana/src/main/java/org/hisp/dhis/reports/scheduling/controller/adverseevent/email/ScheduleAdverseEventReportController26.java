...
public class ScheduleAdverseEventReportController26 implements Action
{
    private static final Log log=LogFactory.getLog(ScheduleAdverseEventReportController26.class);
